...
class PropagationTest2(unittest.TestCase):
    ...
    def create_context(self, reqs, g):
        ...
        as_paths = [(200, 100), (300, 200, 100),
                    (400, 300, 200, 100), (400, 100),
                    (400, 200, 100), (300, 100),
                    (400, 500, 300, 100),]
        ctx = SolverContext.create_context(self.get_anns(),
                                           next_hop_list=next_hops,
                                           peer_list=peers,
                                           as_path_list=as_paths)
        return ctx
    ...
    def test_good_gadget(self):
        ...
        # Action
        ctx = SolverContext.create_context(self.get_anns())
        propagation = EBGPPropagation([r2_req, r3_req, r4_req, r5_req], g, ctx)
